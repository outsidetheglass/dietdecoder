    ...
    private static Callback sRoomDatabaseCallback = new Callback() {
      ...
      public void onCreate(@NonNull SupportSQLiteDatabase db) {
        ...
        databaseWriteExecutor.execute(() -> {
          ...
          recipeDaoWriteExecute(ingredient.getId());
          ingredientLogDaoWriteExecute(ingredient.getId());
          Log.d(TAG, ingredient.toString());
          Log.d(TAG, "ingredientLogDaoWriteExecute");

          Symptom symptom = symptomDaoWriteExecute();
          symptomLogDaoWriteExecute(symptom.getId());
          Log.d(TAG, symptom.toString());
          Log.d(TAG, "symptomLogDaoWriteExecute");
        });
...
//  }; //end static final Migration
  ...
  static final Ingredient ingredientDaoWriteExecute(){
    ...
    Ingredient ingredient = new Ingredient("Rice", "Wild Foods");
    ingredientDao.daoInsertIngredient(ingredient);

    ingredient = new Ingredient("Corn tortilla", "El Rancho");
    ingredientDao.daoInsertIngredient(ingredient);
  ...
  static final void ingredientLogDaoWriteExecute(UUID ingredientId){
    ...
    Log.d(TAG, ingredientLog.toString());
  }
...
static final Symptom symptomDaoWriteExecute(){
  ...
  symptomDao.symptomDaoInsert(
          new Symptom(
                  ...
                  "gut and digestive",
                  "ache, throb, stab", Boolean.TRUE, 0)
  );
  symptomDao.symptomDaoInsert(
          new Symptom(
                  "vomiting",
  ...
  symptomDao.symptomDaoInsert(
          new Symptom(
                  ...
                  "skin",
                  "itch, burn, sting", Boolean.FALSE, 0)
  );
  symptomDao.symptomDaoInsert(
          new Symptom(
                  "psoriasis",
